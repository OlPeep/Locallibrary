...
def index(request):
    ...
    num_flowers=Book.objects.filter(title__icontains="flowers").count()
    ...
    return render(
        ...
        'num_authors':num_authors,'num_genres':num_genres, 'num_flowers':num_flowers, 'num_visits': num_visits,},
    )
